        ...
        <div className="fixed inset-0 z-50 bg-black/40 flex items-center justify-center p-4" onClick={() => setEditing(null)}>
          <div className="bg-card rounded-xl border border-border shadow-lg w-full max-w-2xl max-h-[90vh] overflow-y-auto" onClick={(e) => e.stopPropagation()}>
            ...
            <div className="p-5 grid grid-cols-1 md:grid-cols-2 gap-4">
              ...
              <Field label="Questions to ask them" full><textarea value={editing.candidate_questions || ""} onChange={(e) => setEditing({ ...editing, candidate_questions: e.target.value })} className="w-full min-h-[60px] rounded-lg border border-input bg-card p-3 text-sm" /></Field>
